(function () {
	...
	var Tooltip = {
	    oninit: function (_a) {
	        ...
	        var TextComponent = attrs.TextComponent, TipComponent = attrs.TipComponent;
	        state.showTip = false;
	        if (!TextComponent) {
	    ...
	    view: function (_a) {
	        ...
	        var TextComponent = attrs.TextComponent, TipComponent = attrs.TipComponent;
	        var position = attrs.position, event = attrs.event, type = attrs.type;
	        try {
	            return (m$1("article", { class: "tooltip ".concat(event === 'click' ? 'tooltip--click' : ''), onclick: event === 'click' ? function () { return state.showTip = !showTip; } : undefined, onmouseenter: !event || event === 'hover' ? function () { return state.showTip = true; } : undefined, onmouseleave: !event || event === 'hover' ? function () { return state.showTip = false; } : undefined },
	                m$1("span", { class: "tooltip-text" }, TextComponent),
	                m$1("span", { class: "tip ".concat(type === 'component' ? 'tip--component' : '', " ").concat(!!position ? "tip--".concat(position) : 'tip--below', " ").concat(showTip ? 'tip--visible' : 'tip--hidden') }, TipComponent)));
	        }
	        catch (e) {
	            console.error(e);
	            return (m$1("span", { class: "dib alert alert--danger alert--icon" },
	...
	var Content = {
	    view: function () {
	        return (m$1("article", { className: "pa3 gray6 c-gray1" },
	            m$1("div", { className: "f6 ma0 mb2" },
	                m$1("i", { className: "fas fa-home mr2" }),
	            ...
	            m$1("p", null,
	                ...
	                "Hier etwas mehr Text. Hier etwas mehr Text. Hier etwas mehr Text."),
	            m$1("div", null,
	                m$1("a", { href: "https://www.phoenixreisen.com" }, "Zu Phoenix Reisen"))));
	    }
	};
	var Demo = {
	    view: function () {
	        return ([
	            m$1("div", { className: "pa4 tc" },
	                m$1("div", { className: "ma3" },
	                    m$1(Tooltip, { event: "click", position: "right", type: "component", TipComponent: m$1(Content, null), TextComponent: m$1("i", { class: "fas fa-info-circle c-warning" }) })),
	                m$1("div", { className: "ma3" },
	                    m$1(Tooltip, { position: "left", TextComponent: m$1("span", null, "Hover mich!"), TipComponent: m$1("span", { class: "alert alert--success" }, "Ich bin der 1. Tooltip") })),
	                m$1("div", { className: "ma3" },
	                    m$1(Tooltip, { position: "right", TextComponent: m$1("span", null, "Hover mich auch!"), TipComponent: m$1("span", { class: "alert alert--danger" }, "Ich bin der 2. Tooltip") })),
	                m$1("div", { className: "ma3" },
	                    m$1(Tooltip, { position: "below", TextComponent: m$1("span", null, "Mich auch hovern!"), TipComponent: m$1("span", { class: "alert alert--info" }, "Ich bin der 3. Tooltip") })),
	                m$1("div", { className: "ma3" },
	                    m$1(Tooltip, { position: "above", TextComponent: m$1("span", null,
	                            m$1("i", { class: "fas fa-exclamation-triangle mr2" }),
	                            "Hover mich endlich auch!"), TipComponent: m$1("span", { class: "alert alert--warning" }, "Ich bin der 4. Tooltip!") })),
	                m$1("div", { className: "ma3" },
	                    m$1(Tooltip, { event: "click", position: "below", type: "component", TipComponent: m$1(Content, null), TextComponent: m$1("span", null,
	                            "Ich rendere eine Komponente bei Klick",
	                            m$1("i", { class: "fas fa-info-circle ml2" })) })))
	        ]);
	    }
	};
