(function () {
	...
	var Tooltip = {
	    oninit: function (_a) {
	        ...
	        state.showTip = false;
	        var text = attrs.text, iconname = attrs.iconname;
	        var tooltip = attrs.tooltip, TipComponent = attrs.TipComponent;
	        if (!text && !iconname) {
	    ...
	    view: function (_a) {
	        var state = _a.state, attrs = _a.attrs;
	        var showTip = state.showTip;
	        var text = attrs.text, iconname = attrs.iconname;
	        var tooltip = attrs.tooltip, TipComponent = attrs.TipComponent;
	        var position = attrs.position, color = attrs.color, event = attrs.event;
	        try {
	            return (mithril("article", { class: "tooltip ".concat(event === 'click' ? 'tooltip--click' : ''), onclick: event === 'click' ? function () { return state.showTip = !showTip; } : undefined, onmouseenter: !event || event === 'hover' ? function () { return state.showTip = true; } : undefined, onmouseleave: !event || event === 'hover' ? function () { return state.showTip = false; } : undefined },
	                (iconname === null || iconname === void 0 ? void 0 : iconname.length) && mithril("i", { class: "tooltip-icon fas ".concat(iconname, " ").concat((text === null || text === void 0 ? void 0 : text.length) ? 'mr2' : '') }),
	                (text === null || text === void 0 ? void 0 : text.length) && mithril("span", { class: 'tooltip-text' }, text),
	                mithril("span", { class: "tip ".concat(!!TipComponent ? 'tip--component' : '', " ").concat(!!position ? "tip--".concat(position) : 'tip--below', " ").concat(showTip ? 'tip--visible' : 'tip--hidden') },
	                    !!TipComponent && (TipComponent),
	                    !!tooltip && (mithril("span", { class: color ? "tip--colored ".concat(color) : '' }, tooltip)))));
	        }
	        catch (e) {
	            console.error(e);
	            return (mithril("span", { class: "dib alert alert--danger alert--icon" },
	...
	var Content = {
	    view: function () {
	        return (mithril("article", { className: "pa3 gray6 c-gray1" },
	            mithril("div", { className: "f6 ma0 mb2" },
	                mithril("i", { className: "fas fa-home mr2" }),
	            ...
	            mithril("p", null,
	                ...
	                "Hier etwas mehr Text. Hier etwas mehr Text. Hier etwas mehr Text."),
	            mithril("div", null,
	                mithril("a", { href: "https://www.phoenixreisen.com" }, "Zu Phoenix Reisen"))));
	    }
	};
	var Demo = {
	    view: function () {
	        return ([
	            mithril("div", { className: "pa4 tc" },
	                mithril("div", { className: "ma3" },
	                    mithril(Tooltip, { event: "click", color: "warning", position: "right", iconname: 'fa-info-circle', TipComponent: mithril(Content, null) })),
	                mithril("div", { className: "ma3" },
	                    mithril(Tooltip, { color: "success", position: "left", text: "Hover mich!", tooltip: "Ich bin der 1. Tooltip!" })),
	                mithril("div", { className: "ma3" },
	                    mithril(Tooltip, { color: "danger", position: "right", text: "Hover mich auch!", tooltip: "Ich bin der 2. Tooltip!" })),
	                mithril("div", { className: "ma3" },
	                    mithril(Tooltip, { color: "info", position: "below", text: "Mich auch hovern!", tooltip: "Ich bin der 3. Tooltip!" })),
	                mithril("div", { className: "ma3" },
	                    mithril(Tooltip, { color: "warning", position: "above", text: "Hover mich endlich auch!", tooltip: "Ich bin der 4. Tooltip!", iconname: 'fa-exclamation-triangle' })),
	                mithril("div", { className: "ma3" },
	                    mithril(Tooltip, { event: "click", color: "warning", position: "below", text: "Ich rendere eine Komponente", TipComponent: mithril(Content, null) })))
	        ]);
	    }
	};

	mithril.mount(document.querySelector('.example-app'), Demo);
