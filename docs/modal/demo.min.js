(function () {
	...
	var Item1 = {
	    view: function () {
	        return ([
	            m$1("img", { src: "./phoenix-reisen-flotte.jpg", alt: "Phoenix Flotte", class: "img left" }),
	            m$1("h3", { class: "pt0 mt0" }, "Gut geklickt, Brudi!"),
	...
	var Modal$1 = {
	    ...
	    view: function (v) {
	        ...
	        var sizeClass = size ? Sizes[size] : null;
	        return ([
	            m$1("article", { class: "modal modal--visible ".concat(sizeClass) },
	                m$1("div", { class: "modal__header" },
	                    m$1("span", { class: "modal__headline" }, title || ''),
	                    toggle &&
	                        m$1("a", { class: "modal__toggle", href: "javascript:", onclick: toggle },
	                            withCloseText && m$1("span", { class: "desktop-only" }, "schlie\u00DFen"),
	                            m$1("i", { class: "fas fa-times-circle" }))),
	                m$1("div", { class: "modal__content" }, content || v.children),
	                footer &&
	                    m$1("div", { class: "modal__footer tr" }, footer)),
	            m$1("article", { class: "modal__bg" }),
	        ]);
	    },
	};
	...
	var Demo = {
	    ...
	    view: function (_a) {
	        var state = _a.state;
	        return (m$1("div", { class: "modal-demo" },
	            m$1("div", { class: "box" },
	                m$1("a", { href: "javascript:", onclick: function () { return state.show = true; }, title: "Modal aufrufen", class: "btn btn--link" }, "Klick mich!")),
	            state.show &&
	                m$1(Modal, { title: "Modal Demo", withCloseText: true, toggle: function () { return (state.show = false); }, content: m$1("div", null,
	                        m$1(Item1, null)), footer: m$1("div", { class: "tr" },
	                        m$1("button", { class: "btn btn--secondary mr1", onclick: function () { return (state.show = false); } }, "Abbrechen"),
	                        m$1("button", { class: "btn btn--primary ml1", onclick: function () { return (state.show = false); } }, "Verbindlich buchen")) })));
	    }
	};
