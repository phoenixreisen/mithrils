(function () {
	...
	var Modal$1 = {
	    ...
	    view: function (v) {
	        ...
	        return ([
	            mithril("article", { class: "modal modal--visible ".concat(size || '') },
	...
	var Demo = {
	    ...
	    view: function (_a) {
	        ...
	        return (mithril("div", { class: "modal-demo" },
	            ...
	            state.show &&
	                mithril(Modal, { title: "Modal Demo", withCloseText: true, toggle: function () { return (state.show = false); }, content: mithril("div", null,
