    ...
    var FuzzyInput = {
        ...
        view: function (_a) {
            ...
            return (mithril("article", { class: "fuzzy-search fuzzy-show-result" },
                showErrormsg && (mithril("div", { class: "pulse animated fuzzy-error" },
                ...
                showWarnmsg && (mithril("div", { class: "pulse animated fuzzy-warning" },
                ...
                mithril("div", { class: attrs.withButton ? 'fuzzy-with-button' : '' },
                    mithril("label", { class: "textfield fuzzy-input ".concat(attrs.disabled ? 'disabled' : '') },
                        mithril("input", { type: "text", value: value, id: "".concat(attrs.id || ID), name: "".concat(attrs.id || ID), readonly: attrs.readonly || false, placeholder: placeholder || '...', maxlength: maxLength || MAXLENGTH, onblur: attrs.onblur || undefined, oninput: function (e) { return search(e.target.value, state, attrs); } }),
                        mithril("span", { class: "textfield__label" }, label || 'Suche')),
                    attrs.withButton && (mithril("button", { type: "button", class: "btn btn--secondary", onclick: function () { return callQuery(state, attrs); } },
                    ...
                    mithril("div", { class: "fuzzy-overlay fuzzy-result fuzzy-style" },
                        mithril("div", { class: "fadeIn animated faster" }, result === null || result === void 0 ? void 0 :
                            result.map(function (name, index) {
                                return mithril("a", { id: "".concat(attrs.id || ID, "-item-").concat(index), href: "javascript:", onclick: function () { return load(name, state, attrs); } }, name);
                            }),
