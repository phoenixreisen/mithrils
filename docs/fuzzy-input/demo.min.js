(function () {
    ...
    ***************************************************************************** */
    ...
    function reset(state, attrs, e) {
        if (!e || e.key === 'Escape') {
            if (attrs === null || attrs === void 0 ? void 0 : attrs.clearAfterLoad) {
    ...
    function findMatch(input, prefix) {
        var _a, _b, _c;
        var pattern = "".concat(prefix, "[0-9a-zA-Z\u00FC\u00F6\u00E4\u00DC\u00D6\u00C4\u00DF_#%\\?\\-\\+]*(\\s|$)");
        ...
        return attrs.load(choice)
            ...
            if (attrs.inText) {
                ...
                if (state.match) {
                    ...
                    var pattern = new RegExp("".concat(state.match, "(\\s|$)"));
                    setValue(value.replace(pattern, "".concat(prefix).concat(choice).concat(suffix, " ")), state, attrs);
                }
                else {
                    var $input = document.querySelector("#".concat(attrs.id || ID));
                    ...
                    if (typeof cursorPosition !== 'undefined') {
                        ...
                        setValue("".concat(start).concat(prefix).concat(choice).concat(suffix).concat(end), state, attrs);
                    }
                    else {
                        setValue("".concat(getValue(state, attrs)).concat(prefix).concat(choice).concat(suffix), state, attrs);
                    }
                }
                (_b = document.querySelector("#".concat(attrs.id || ID))) === null || _b === void 0 ? void 0 : _b.focus();
                m$1.redraw();
            }
            else {
    ...
    function focus(state, attrs, e, callback) {
        ...
        if (move && (result === null || result === void 0 ? void 0 : result.length)) {
            state.focused = move();
            var id = "#".concat(attrs.id || ID, "-item-").concat(state.focused);
    ...
    var FuzzyInput = {
        ...
        oncreate: function (_a) {
            ...
            events.ESCAPE = function (e) { return reset(state, attrs, e); };
        ...
        view: function (_a) {
            ...
            return (m$1("article", { class: "fuzzy-search fuzzy-show-result" },
                showErrormsg && (m$1("div", { class: "pulse animated fuzzy-error" },
                    m$1("div", { class: "alert alert--danger alert--icon" },
                        m$1("i", { class: "fas fa-times" }),
                        attrs.errormsg || 'Oha, während der Abfrage ist ein Fehler aufgetreten.'))),
                showWarnmsg && (m$1("div", { class: "pulse animated fuzzy-warning" },
                    m$1("div", { class: "alert alert--warning alert--icon" },
                        m$1("i", { class: "fas fa-exclamation-triangle" }),
                        attrs.warnmsg || 'Ungültige Eingabe.'))),
                m$1("div", { class: attrs.withButton ? 'fuzzy-with-button' : '' },
                    m$1("label", { class: "textfield fuzzy-input ".concat(attrs.disabled ? 'disabled' : '') },
                        m$1("input", { type: "text", value: value, id: "".concat(attrs.id || ID), name: "".concat(attrs.id || ID), readonly: attrs.readonly || false, placeholder: placeholder || '...', maxlength: maxLength || MAXLENGTH, onblur: attrs.onblur || undefined, oninput: function (e) { return search(e.target.value, state, attrs); } }),
                        m$1("span", { class: "textfield__label" }, label || 'Suche')),
                    attrs.withButton && (m$1("button", { type: "button", class: "btn btn--secondary", onclick: function () { return callQuery(state, attrs); } },
                        m$1("i", { class: "fas fa-list" })))),
                showResultlist && [
                    m$1("div", { class: "fuzzy-overlay fuzzy-result fuzzy-style" },
                        m$1("div", { class: "fadeIn animated faster" }, result === null || result === void 0 ? void 0 :
                            result.map(function (name, index) {
                                return m$1("a", { id: "".concat(attrs.id || ID, "-item-").concat(index), href: "javascript:", onclick: function () { return load(name, state, attrs); } }, name);
                            }),
                            (!result || !result.length) ?
                                m$1("div", { class: "ma2" },
                                    m$1("em", null, "Die Suche ergab leider keine Treffer..."))
                                : '')),
                    m$1("div", { class: "fuzzy-bg-layer", onclick: function () { return reset(state); } }),
                ]));
        }
    };
    ...
    function load1(name) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                location.href = "https://www.google.de/search?q=".concat(name);
                console.log(name);
                return [2, name];
            });
        });
    ...
    var Demo = {
        ...
        view: function (_a) {
            var state = _a.state;
            return (m$1("div", { class: "fuzzy-demo" },
                m$1("p", null,
                    m$1("strong", null, "Eingabefeld f\u00FCr Autocomplete."),
                    m$1("br", null),
                    "Eingabe: ",
                    m$1("em", null, state.input1 || '-')),
                m$1(FuzzyInput, { minLength: 1, id: "example-1", pattern: new RegExp(/[{a-zA-Z]/), label: 'Name eines Landes (engl.)', warnmsg: 'Ungueltige Eingabe', errormsg: 'Huch, ein Fehler ist aufgetreten.', value: function () { return state.input1; }, load: function (choice) { return load1(choice); }, query: function (needle) { return query1(needle); }, oninput: function (value) { return Object.assign(state, { input1: value }); } }),
                m$1("hr", { class: "mv4" }),
                m$1("p", null,
                    m$1("strong", null, "Freies Eingabefeld mit Platzhaltersuche."),
                    m$1("br", null),
                    ...
                    m$1("br", null),
                    "Eingabe: ",
                    m$1("em", null, state.input2 || '-')),
                m$1(FuzzyInput, { inText: {
                        prefix: '{{',
                        suffix: '}}'
