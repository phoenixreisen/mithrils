(function () {
	...
	var Loader = {
	    view: function (_a) {
	        var attrs = _a.attrs;
	        var type = attrs.type, text = attrs.text, iconname = attrs.iconname;
	        if (type && type === 'overlay') {
	            return (mithril("article", { class: "loader loader--overlay" },
	                mithril("p", { class: "loader__spinner" },
	                    mithril("i", { class: "".concat(iconname || 'fab fa-cuttlefish', " fa-spin") }),
	                    mithril("br", null),
	                    text || 'Daten werden geladen...')));
	        }
	        return (mithril("article", { class: "loader" },
	            mithril("p", { class: "loader__spinner" },
	                mithril("i", { class: "".concat(iconname || 'fab fa-cuttlefish', " fa-spin") })),
	            mithril("p", { class: "loader__text" }, text || 'Daten werden geladen...')));
	    }
	};
	...
	var Root = {
	    view: function () {
	        return ([
	            mithril(LoaderView, { text: "Daten werden geladen..." })
	        ]);
	    },
	};
