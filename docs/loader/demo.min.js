var bundle = (function (exports) {
	...
	var Loader = {
	    view: function (_a) {
	        var attrs = _a.attrs;
	        var type = attrs.type, text = attrs.text, iconname = attrs.iconname, showGif = attrs.showGif, noText = attrs.noText;
	        if (type && type === 'overlay') {
	            return (m$1("article", { class: "loader loader--overlay" },
	                m$1("p", { class: "loader__spinner" },
	                    (showGif)
	                        ? m$1("img", { src: ship })
	                        : m$1("i", { class: "".concat(iconname || 'fab fa-cuttlefish', " fa-spin") }),
	                    !noText && ([
	                        m$1("br", null),
	                        (showGif) && (m$1("i", { class: "".concat(iconname || 'fab fa-cuttlefish', " fa-spin mr2") })),
	                        text || 'Daten werden geladen...',
	                    ]))));
	        }
	        return (m$1("article", { class: "loader" },
	            m$1("p", { class: "loader__spinner" }, (showGif)
	                ? m$1("img", { src: ship })
	                : m$1("i", { class: "".concat(iconname || 'fab fa-cuttlefish', " fa-spin") })),
	            !noText && (m$1("p", { class: "loader__text" },
	                (showGif) && (m$1("i", { class: "".concat(iconname || 'fab fa-cuttlefish', " fa-spin mr2") })),
	                text || 'Daten werden geladen...'))));
	    }
	};
	...
	var Demo = {
	    view: function () {
	        return ([
	            m$1("h3", null, "Standard Loader"),
	            m$1(Loader, { text: "Demo wird geladen..." }),
	            m$1("h3", null, "Loader mit Gif"),
	            m$1(Loader, { text: "Demo wird geladen...", showGif: true }),
	            m$1("h3", null, "Loader ohne Text"),
	            m$1(Loader, { noText: true }),
	            m$1("h3", null, "Loader mit Gif ohne Text"),
	            m$1(Loader, { noText: true, showGif: true }),
	            m$1("h3", null, "Loader als Overlay"),
	            m$1("div", { style: { position: 'relative', width: '100%', border: '1px solid black' } },
	                m$1(Loader, { type: "overlay", text: "Demo wird geladen..." }),
	                m$1("div", { style: { textAlign: 'center', fontWeight: 'bold', margin: '1rem' } }, "Loader als Overlay \u00FCber gesamten relativen Container"),
	                m$1("div", { style: { textAlign: 'center', fontWeight: 'bold', margin: '1rem' } }, "Loader als Overlay \u00FCber gesamten relativen Container"),
	                m$1("div", { style: { textAlign: 'center', fontWeight: 'bold', margin: '1rem' } }, "Loader als Overlay \u00FCber gesamten relativen Container"),
	                m$1("div", { style: { textAlign: 'center', fontWeight: 'bold', margin: '1rem' } }, "Loader als Overlay \u00FCber gesamten relativen Container"),
	                m$1("div", { style: { textAlign: 'center', fontWeight: 'bold', margin: '1rem' } }, "Loader als Overlay \u00FCber gesamten relativen Container")),
	            m$1("h3", null, "Loader als Overlay mit Gif"),
	            m$1("div", null, "Das Gif sollte nicht mit dem Overlay verwendet werden. Sieht nicht gut aus. Aber es ginge."),
	            m$1("div", { style: { position: 'relative', width: '100%', border: '1px solid black', marginTop: '1rem' } },
	                m$1(Loader, { type: "overlay", text: "Demo wird geladen...", showGif: true }),
	                m$1("div", { style: { textAlign: 'center', fontWeight: 'bold', margin: '1rem' } }, "Loader als Overlay \u00FCber gesamten relativen Container"),
	                m$1("div", { style: { textAlign: 'center', fontWeight: 'bold', margin: '1rem' } }, "Loader als Overlay \u00FCber gesamten relativen Container"),
	                m$1("div", { style: { textAlign: 'center', fontWeight: 'bold', margin: '1rem' } }, "Loader als Overlay \u00FCber gesamten relativen Container"),
	                m$1("div", { style: { textAlign: 'center', fontWeight: 'bold', margin: '1rem' } }, "Loader als Overlay \u00FCber gesamten relativen Container"),
