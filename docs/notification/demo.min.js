(function () {
	...
	var Notification = {
	    ...
	    view: function (_a) {
	        ...
	        return (mithril("article", { class: "notification notification--".concat(status || 'primary') },
	            mithril("i", { class: "fas fa-".concat(this.icon) }),
	    ...
	    view: function () {
	        return (mithril("div", { class: "modal-demo" },
	            mithril("div", { class: "box" },
	                ...
	                mithril("hr", null),
	                mithril("div", { class: "pa3 ma2" },
	                    mithril("a", { href: "javascript:", onclick: function () { return notes.add(msg("success")); }, title: " aufrufen", class: "btn btn--success" }, "Klick mich f\u00FCr Erfolg!")),
	                mithril("hr", null),
	                mithril("div", { class: "pa3 ma2" },
	                    mithril("a", { href: "javascript:", onclick: function () { return notes.add(msg("error")); }, title: " aufrufen", class: "btn btn--danger" }, "Klick mich f\u00FCr Fehler!")),
	                mithril("hr", null)),
