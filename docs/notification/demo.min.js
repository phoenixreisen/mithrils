(function () {
	...
	var Note = {
	    ...
	    view: function (_a) {
	        ...
	        return (m$1("article", { class: "notification notification--".concat(status || 'primary') },
	            m$1("i", { class: "fas fa-".concat(this.icon) }),
	            m$1("span", null, text),
	            m$1("a", { href: "javascript:", class: "fas fa-times", onclick: function () {
	                    toggle();
	                    m$1.redraw();
	                } })));
	    }
	    ...
	    view: function (_a) {
	        ...
	        return ([
	            Array.from(list).map(function (note) {
	                return m$1(Notification, { text: note.text, status: note.status, toggle: function () { return list.delete(note); } });
	            }),
	        ]);
	    }
	};
	...
	var Demo = {
	    view: function () {
	        return (m$1("div", { class: "modal-demo" },
	            m$1("div", { class: "box" },
	                m$1("div", { class: "pa3 ma2" },
	                    m$1("a", { href: "javascript:", onclick: function () { return notes.add(msg(undefined)); }, title: " aufrufen", class: "btn btn--primary-dark" }, "Klick mich f\u00FCr Standard!")),
	                m$1("hr", null),
	                m$1("div", { class: "pa3 ma2" },
	                    m$1("a", { href: "javascript:", onclick: function () { return notes.add(msg("success")); }, title: " aufrufen", class: "btn btn--success" }, "Klick mich f\u00FCr Erfolg!")),
	                m$1("hr", null),
	                m$1("div", { class: "pa3 ma2" },
	                    m$1("a", { href: "javascript:", onclick: function () { return notes.add(msg("error")); }, title: " aufrufen", class: "btn btn--danger" }, "Klick mich f\u00FCr Fehler!")),
	                m$1("hr", null)),
	            m$1(Notifications, { list: notes })));
	    }
	};
