(function () {
	...
	var _checkParameters = function (vnode) {
	    var attrs = vnode.attrs;
	    var children = vnode.children;
	...
	var _changeTab = function (vnode, tabnr) {
	...
	var Tabs$1 = {
	    ...
	    view: function (vnode) {
	        var state = vnode.state, attrs = vnode.attrs;
	        var children = vnode.children;
	        var changeTab = attrs.changeTab || _changeTab;
	        var activeTab = attrs.activeTab && (attrs.activeTab < attrs.tabs.length)
	            ? attrs.activeTab
	            : state.activeTab;
	        return (mithril("article", { class: "tabs" },
	            mithril("div", { class: "tabs__tabs-bar" }, attrs.tabs.map(function (tabname, tabnr) {
	                return (mithril("a", { class: "tab tab-".concat(tabnr, " ").concat(attrs.tabs.length > 1 ? 'tab--link' : '', " ").concat(tabnr === activeTab ? 'is-active-tab' : 'is-inactive-tab'), onclick: function () { return changeTab(vnode, tabnr); } }, tabname));
	            })),
	            mithril("div", { class: "tabs__tabs-content" }, children.map(function (content, tabnr) {
	                return (mithril("div", { class: "tab-content tab-content-".concat(tabnr, " ").concat(tabnr === activeTab ? 'is-visible-tab' : 'is-hidden-tab') }, content));
	            }))));
	    },
	};
	...
	var Demo = {
	    view: function () {
	        return (mithril(Tabs, { tabs: ['Tab I', 'Tab II', 'Tab III'] },
	            mithril("div", { className: "pa3" }, "Tab I"),
	            mithril("div", { className: "pa3" }, "Tab II"),
	            mithril("div", { className: "pa3" }, "Tab III")));
	    }
	};
