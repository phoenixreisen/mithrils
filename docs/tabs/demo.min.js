(function () {
	...
	var Tabs = {
	    ...
	    view: function (vnode) {
	        ...
	        var activeTab = attrs.activeTab && (attrs.activeTab < attrs.tabs.length)
	            ? attrs.activeTab
	            : state.activeTab;
	        return (m$1("article", { class: "tabs" },
	            m$1("div", { class: "tabs__tabs-bar" }, attrs.tabs.map(function (tabname, tabnr) {
	                return (m$1("a", { class: "tab tab-".concat(tabnr, " ").concat(attrs.tabs.length > 1 ? 'tab--link' : '', " ").concat(tabnr === activeTab ? 'is-active-tab' : 'is-inactive-tab'), onclick: function () { return changeTab(vnode, tabnr); } }, tabname));
	            })),
	            m$1("div", { class: "tabs__tabs-content" }, children.map(function (content, tabnr) {
	                return (m$1("div", { class: "tab-content tab-content-".concat(tabnr, " ").concat(tabnr === activeTab ? 'is-visible-tab' : 'is-hidden-tab') }, content));
	            }))));
	    },
	};
	...
	var Demo = {
	    view: function () {
	        return (m$1(Tabs, { tabs: ['Tab I', 'Tab II', 'Tab III'] },
	            m$1("div", { className: "pa3" }, "Tab I"),
	            m$1("div", { className: "pa3" }, "Tab II"),
	            m$1("div", { className: "pa3" }, "Tab III")));
	    }
	};
