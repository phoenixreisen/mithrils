(function () {
    ...
    ***************************************************************************** */
    ...
    function getWebtext(webtexts, webtextName, placeholders) {
    ...
    var Webtext = {
        oninit: function (_a) {
            ...
            var webtexts = attrs.webtexts, webtextName = attrs.webtextName, placeholders = attrs.placeholders;
            ...
            state.update(__assign(__assign({}, state), { webtext: getWebtext(webtexts, webtextName, placeholders) }));
        },
        view: function (_a) {
            var attrs = _a.attrs, state = _a.state;
            ...
            var title = (!!webtextName && showWebtextName)
                ...
                : undefined;
            if (!webtext && altText) {
                return (m$1("article", { class: "webtext ".concat(cssClass || ''), title: title }, m$1.trust(striptags(altText, allowedHtmlTags || ALLOWED_HTML))));
            }
            else if (!webtext) {
                return null;
            }
    ...
    var Demo = {
        view: function () {
            return (m$1("section", { class: "webtext-demo" },
                ...
                m$1(Webtext, { webtexts: Webtexts, showWebtextName: false, webtextName: "gibts-nicht", altText: 'Ich werde stattdessen angezeigt.' }),
