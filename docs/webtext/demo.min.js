(function () {
	...
	var Webtext = {
	    ...
	    view: function (_a) {
	        var attrs = _a.attrs;
	        var webtexts = attrs.webtexts, webtextName = attrs.webtextName, altText = attrs.altText;
	        var cssClass = attrs.cssClass, wtmLink = attrs.wtmLink, wtmLinkTitle = attrs.wtmLinkTitle;
