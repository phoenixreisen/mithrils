	    ...
	    view: function (_a) {
	        ...
	        if (!webtext) {
	            ...
	            return (m$1("article", { class: "webtext ".concat(cssClass || ''), title: title },
	                m$1("span", null, asPlainText
	                    ? webtext
	                    : m$1.trust(striptags(webtext, (allowedHtmlTags || ALLOWED_HTML)))),
	                wtmLink && (m$1("a", { class: "ml1", href: wtmLink, target: "_blank", rel: "noopener noreferrer", title: wtmLinkTitle || 'Im Webtext-Manager öffnen' },
	...
	var Demo = {
	    view: function () {
	        return (m$1("section", { class: "webtext-demo" },
	            ...
	            m$1(Webtext, { webtexts: Webtexts, webtextName: "webtext3", wtmLink: 'https://meinereise.phoenixreisen.com/cdn/mitarbeiter/webtext-verwaltung/#!form/tefra__text/MeinPhoenix' })));
	    }
	};
