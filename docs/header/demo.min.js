(function () {
	...
	var Header = {
	    view: function (_a) {
	        ...
	        return (mithril("article", { class: "header" },
	            ...
	            !!version && (mithril("div", { class: "header__version" }, version)),
	            !!toggleNav && (mithril("div", { class: "header__nav-btn" },
	                mithril("a", { href: "javascript:", class: "nav-btn noprint", title: "Navigation ein- & ausblenden", onclick: function () { return toggleNav(); } },
	...
	var Topbar = {
	    ...
	    view: function (_a) {
	        ...
	        var AvatarComponent = attrs.AvatarComponent, NavComponent = attrs.NavComponent;
	        ...
	        return (mithril("article", { class: "top-bar noprint ".concat(isVisible ? 'top-bar--visible' : '') },
	            mithril("div", { class: "wrapper wrapper--large" },
	                mithril("div", { class: "top-bar__left" },
	                    !!backUrl && (mithril("a", { href: backUrl, title: "zur\u00FCck", class: "top-bar__back-btn" },
	                ...
	                !!toggleAvatar && (mithril("article", { class: "top-bar__avatar noprint" },
	                    ...
	                    !!AvatarComponent && (mithril(AvatarComponent, null)))),
	                !!toggleNav && (mithril("article", { class: "top-bar__nav-btn noprint" },
	                    mithril("a", { href: "javascript:", class: "nav-btn", title: "Navigation ein-/ausblenden", onclick: function (e) { return toggleNav(e); } },
	                        mithril("i", { class: "fas fa-bars" })),
	                    !!NavComponent && (mithril(NavComponent, null)))))));
	    }
	};
