(function () {
	...
	function execSelector(state, vnode) {
		...
		var children = Vnode$4.normalizeChildren(vnode.children);
	...
	var mountRedraw$2 = mountRedraw$3(render, requestAnimationFrame, console);
	...
	var request$1 = request$2(window, PromisePolyfill, mountRedraw$1.redraw);
	...
	function requireRoute () {
		...
		route = requireRouter()(window, mountRedraw);
		return route;
	}
	...
	var checkPosition = function (state) {
	...
	var Topbar = {
	    ...
	    view: function (_a) {
	        ...
	        return (mithril("article", { class: "top-bar noprint ".concat(isVisible ? 'top-bar--visible' : '') },
	            mithril("div", { class: "wrapper wrapper--large" },
	                mithril("div", { class: "top-bar__left" },
	                    backUrl ?
	                        mithril("a", { href: backUrl, title: "zur\u00FCck", class: "top-bar__back-btn" },
	                            mithril("i", { class: "fas fa-arrow-left" }))
	                        : '',
	                    mithril("a", { href: faviconTarget || 'https://www.phoenixreisen.com', title: "zur Startseite" },
	                        mithril("img", { src: faviconUrl || 'https://phoenixreisen.com/favicon.png', class: "top-bar__icon", alt: "" }),
	                        mithril("span", { class: "ml1" }, name))),
	                toggleAvatar ?
	                    mithril("article", { class: "top-bar__avatar noprint" },
	                        mithril("a", { href: "javascript:", class: "avatar-cta avatar-cta--topbar", title: "Service, Einstellungen & Optionen", onclick: function (e) { return toggleAvatar(e); } },
	                            mithril("i", { class: "fas fa-user avatar__symbol" })))
	                    : '',
	                toggleNav ?
	                    mithril("a", { href: "javascript:", class: "nav-btn top-bar__nav-btn noprint", title: "Navigation ein-/ausblenden", onclick: function (e) { return toggleNav(e); } },
	                        mithril("i", { class: "fas fa-bars" }))
	                    : '')));
	    }
	};
	...
	var Header = {
	    view: function (_a) {
	        ...
	        var href = !url
	            ? "".concat(protocol || '', "//").concat(host).concat(((pathname === null || pathname === void 0 ? void 0 : pathname.length) > 1) ? pathname : '')
	            : url;
	        return (mithril("article", { class: "header" },
	            mithril("a", { href: href, target: tab || '_self', title: title || '' },
	                mithril("picture", { class: "header__logo" },
	                    mithril("img", { src: logo }))),
	            version ?
	                mithril("div", { class: "header__version" }, version)
	                : '',
	            toggleNav ?
	                mithril("div", { class: "header__nav-btn" },
	                    mithril("a", { href: "javascript:", title: "Navigation ein- & ausblenden", class: "nav-btn noprint", onclick: function () { return toggleNav(); } },
	                        mithril("i", { class: "fas fa-bars" })))
	                : ''));
	    },
	};
	...
	var Root = {
	    ...
	    view: function (_a) {
	        var state = _a.state;
	        return ([
	            mithril('div', { class: 'wrapper wrapper--large' }, mithril(Header, {
