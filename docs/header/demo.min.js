(function () {
	...
	var Header = {
	    view: function (_a) {
	        ...
	        var href = !url
	            ...
	            : url;
	        return (m$1("article", { class: "header" },
	            m$1("a", { href: href, target: tab || '_self', title: title || '' },
	                m$1("picture", { class: "header__logo" },
	                    m$1("img", { src: logo }))),
	            !!version && (m$1("div", { class: "header__version" }, version)),
	            !!toggleNav && (m$1("div", { class: "header__nav-btn" },
	                m$1("a", { href: "javascript:", class: "nav-btn noprint", title: "Navigation ein- & ausblenden", onclick: function () { return toggleNav(); } },
	                    m$1("i", { class: "fas fa-bars" }))))));
	    },
	};
	...
	var Topbar = {
	    ...
	    view: function (_a) {
	        ...
	        return (m$1("article", { class: "top-bar noprint ".concat(isVisible ? 'top-bar--visible' : '') },
	            m$1("div", { class: "wrapper wrapper--large" },
	                m$1("div", { class: "top-bar__left" },
	                    !!backUrl && (m$1("a", { href: backUrl, title: "zur\u00FCck", class: "top-bar__back-btn" },
	                        m$1("i", { class: "fas fa-arrow-left" }))),
	                    m$1("a", { href: faviconTarget || 'https://www.phoenixreisen.com', title: "zur Startseite" },
	                        m$1("img", { src: faviconUrl || 'https://phoenixreisen.com/favicon.png', class: "top-bar__icon", alt: "" }),
	                        m$1("span", { class: "ml1" }, name))),
	                !!toggleAvatar && (m$1("article", { class: "top-bar__avatar noprint" },
	                    m$1("a", { href: "javascript:", class: "avatar-cta avatar-cta--topbar", title: "Service, Einstellungen & Optionen", onclick: function (e) { return toggleAvatar(e); } },
	                        m$1("i", { class: "fas fa-user avatar__symbol" })),
	                    !!AvatarComponent && (AvatarComponent))),
	                !!toggleNav && (m$1("article", { class: "top-bar__nav-btn noprint" },
	                    m$1("a", { href: "javascript:", class: "nav-btn", title: "Navigation ein-/ausblenden", onclick: function (e) { return toggleNav(e); } },
	                        m$1("i", { class: "fas fa-bars" })),
	...
	var Root = {
	    ...
	    view: function (_a) {
	        var state = _a.state;
	        return ([
	            m$1('div', { class: 'wrapper wrapper--large' }, m$1(Header, {
