(function () {
	...
	var TimeLine = {
	    oninit: function (_a) {
	        ...
	        var position = attrs.position, line = attrs.line, side = attrs.side;
	        state.modifier = '';
	    ...
	    view: function (_a) {
	        var state = _a.state, attrs = _a.attrs, children = _a.children;
	        var line = attrs.line, side = attrs.side;
	        var modifier = state.modifier, position = state.position;
	        var contents = children;
	        return (m$1("section", { class: "timeline ".concat(modifier, " ").concat(position === 'left' ? 'timeline--left' : 'timeline--center') },
	            line !== 'separated' &&
	                m$1("span", { class: "timeline-axis" }),
	            (contents).map(function (child, childnr) {
	                var transition = 500;
	                var isOdd = (childnr % 2) === 1;
	                var delayPerSection = transition * childnr;
	                return (m$1("article", { class: "timeline-box" },
	                    (line === 'separated') &&
	                        m$1("span", { class: "timeline-axis", style: "transition: height ".concat(transition, "ms ease ").concat(delayPerSection, "ms") }),
	                    (position === 'left') && (m$1("div", { class: "timeline-left-box" },
	                        m$1("i", { class: "timeline-circle" }),
	                        m$1("div", { class: "timeline-content" }, child))),
	                    (position === 'center') && (m$1("div", { class: "timeline-center-box" },
	                        m$1("i", { class: "timeline-circle" }),
	                        m$1("div", { class: "timeline-content timeline-content--left" },
	                            !(side === null || side === void 0 ? void 0 : side.get(childnr)) && !isOdd && child,
	                            (side === null || side === void 0 ? void 0 : side.get(childnr)) === 'left' && child),
	                        m$1("div", { class: "timeline-content timeline-content--right" },
	                            !(side === null || side === void 0 ? void 0 : side.get(childnr)) && isOdd && child,
	                            (side === null || side === void 0 ? void 0 : side.get(childnr)) === 'right' && child)))));
	            })));
	    },
	};
	...
	var Demo = {
	    view: function () {
	        ...
	        side.set(3, 'left');
	        return ([
	            m$1("h3", null, "Links ausgerichtet"),
	            m$1(TimeLine, { animated: true, line: 'constantly', position: 'left' },
	                m$1("div", { className: "pa3 pt0" },
	                    m$1("div", null,
	                        m$1("strong", null, "Tab I")),
	                    m$1("p", null, "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet."),
	                    m$1("p", null, "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.")),
	                m$1("div", { className: "pa3 pt0" },
	                    m$1("div", null,
	                        m$1("strong", null, "Tab II")),
	                    m$1("p", null, "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet."),
	                    m$1("p", null, "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.")),
	                m$1("div", { className: "pa3 pt0" },
	                    m$1("div", null,
	                        m$1("strong", null, "Tab IIII")),
	                    m$1("p", null, "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet."),
	                    m$1("p", null, "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet."))),
	            m$1("hr", { class: "mv3 pv3" }),
	            m$1("h3", { class: "pt0" }, "Zentriert ausgerichtet"),
	            m$1(TimeLine, { animated: true, line: 'separated', position: 'center', side: side },
	                m$1("div", { className: "pa3 pt0" },
	                    m$1("div", null,
	                        m$1("strong", null, "Tab I")),
	                    m$1("p", null, "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet."),
