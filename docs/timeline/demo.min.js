(function () {
	...
	var TimeLine = {
	    ...
	    view: function (_a) {
	        ...
	        return (mithril("section", { class: "timeline ".concat(modifier, " ").concat(position === 'left' ? 'timeline--left' : 'timeline--center') },
	            line !== 'separated' &&
	                mithril("span", { class: "timeline-axis" }),
	            (contents).map(function (child, childnr) {
	                var transition = 500;
	                var isOdd = (childnr % 2) === 1;
	                var delayPerSection = transition * childnr;
	                return (mithril("article", { class: "timeline-box" },
	                    (line === 'separated') &&
	                        mithril("span", { class: "timeline-axis", style: "transition: height ".concat(transition, "ms ease ").concat(delayPerSection, "ms") }),
	                    (position === 'left') && (mithril("div", { class: "timeline-left-box" },
	                        mithril("i", { class: "timeline-circle" }),
	                        mithril("div", { class: "timeline-content" }, child))),
	                    (position === 'center') && (mithril("div", { class: "timeline-center-box" },
	                        mithril("i", { class: "timeline-circle" }),
	                        mithril("div", { class: "timeline-content timeline-content--left" },
	                            !(side === null || side === void 0 ? void 0 : side.get(childnr)) && !isOdd && child,
	                            (side === null || side === void 0 ? void 0 : side.get(childnr)) === 'left' && child),
	                        mithril("div", { class: "timeline-content timeline-content--right" },
	                            !(side === null || side === void 0 ? void 0 : side.get(childnr)) && isOdd && child,
	...
	var Demo = {
	    view: function () {
	        ...
	        side.set(3, 'left');
	        return ([
	            mithril("h3", null, "Links ausgerichtet"),
	            mithril(TimeLine, { animated: true, line: 'constantly', position: 'left' },
	                mithril("div", { className: "pa3 pt0" },
	                    mithril("div", null,
	                        mithril("strong", null, "Tab I")),
	                    mithril("p", null, "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet."),
	                    mithril("p", null, "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.")),
	                mithril("div", { className: "pa3 pt0" },
	                    mithril("div", null,
	                        mithril("strong", null, "Tab II")),
	                    mithril("p", null, "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet."),
	                    mithril("p", null, "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.")),
	                mithril("div", { className: "pa3 pt0" },
	                    mithril("div", null,
	                        mithril("strong", null, "Tab IIII")),
	                    mithril("p", null, "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet."),
	                    mithril("p", null, "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet."))),
	            mithril("hr", { class: "mv3 pv3" }),
	            mithril("h3", { class: "pt0" }, "Zentriert ausgerichtet"),
	            mithril(TimeLine, { animated: true, line: 'separated', position: 'center', side: side },
	                mithril("div", { className: "pa3 pt0" },
	                    mithril("div", null,
	                        mithril("strong", null, "Tab I")),
	                    mithril("p", null, "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet."),
