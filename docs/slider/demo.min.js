  ...
  .replace(/ /g, '.')}`;
	...
	var Slider = {
	    oncreate: function (vnode) {
	        ...
	        state.slider = new Swiper(".".concat(attrs.name), {
	            pagination: {
	    ...
	    view: function (_a) {
	        ...
	        return (mithril("div", { class: "swiper ".concat(name) },
	            mithril("div", { class: "swiper-wrapper" }, slides.map(function (slide, index) {
	                return mithril("div", { class: "swiper-slide", key: "slide-".concat(index) }, slide);
	            })),
	            mithril("div", { class: "swiper-scrollbar swiper-scrollbar-".concat(name) }),
	            mithril("div", { class: "swiper-button-prev swiper-button-prev-".concat(name) },
	                mithril("i", { class: "fas fa-arrow-circle-left" })),
	            mithril("div", { class: "swiper-button-next swiper-button-next-".concat(name) },
	                mithril("i", { class: "fas fa-arrow-circle-right" })),
	            mithril("div", { class: "swiper-pagination swiper-pagination-".concat(name) })));
	    }
	};
	...
	var Root = {
	    view: function () {
	        return ([
	            mithril("p", null,
	                mithril("strong", null, "I. Slider")),
	            mithril(Slider, { name: 'swiper-1', slides: [Slide, Slide, Slide] }),
	            mithril("div", { class: "pv4" }),
	            mithril("p", null,
	                mithril("strong", null, "II. Slider auf selber Seite")),
	            mithril(Slider, { name: 'swiper-2', slides: [Slide, Slide, Slide] }),
	        ]);
	    },
	};
