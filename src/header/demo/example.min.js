    ...
    var Header = {
        view: function (_a) {
            ...
            var href = !url
                ...
                : url;
            return (m__default['default']("article", { class: "header" },
                m__default['default']("a", { href: href, target: tab || '_self', title: title || '' },
                    m__default['default']("picture", { class: "header__logo" },
                        m__default['default']("img", { src: logo }))),
                version ?
                    m__default['default']("div", { class: "header__version" }, version)
                    : '',
                toggleNav ?
                    m__default['default']("div", { class: "header__nav-btn" },
                        m__default['default']("a", { href: "javascript:", title: "Navigation ein- & ausblenden", class: "nav-btn noprint", onclick: function () { return toggleNav(); } },
