(function () {
	...
	var _checkParameters = function (vnode) {
	    var attrs = vnode.attrs;
	    var children = vnode.children;
	    console.log(attrs.tabs.length, children.length);
	    ...
	    view: function (vnode) {
	        ...
	        return (mithril("article", { class: "tabs" },
	            mithril("div", { class: "tabs__tabs-bar" }, attrs.tabs.map(function (tabname, tabnr) {
	                console.log('active', vnode.state.activeTab, 'tabnr', tabnr);
	                console.log('class', "tab tab-".concat(tabnr, " ").concat(attrs.tabs.length > 1 ? 'tab--link' : '', " ").concat(tabnr === activeTab ? 'is-active-tab' : 'is-inactive-tab'));
